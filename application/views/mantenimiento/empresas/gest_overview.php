...
<div class="post d-flex flex-column-fluid" id="kt_post">
	<div id="kt_content_container" class="container-xxl">			
					...
					<div class="d-flex flex-wrap">
						...
						<div class="flex-equal me-5">
							<table class="table table-flush fw-bold gy-1">
								<tr>
									<td class="text-muted min-w-125px w-125px">TIPO CLIENTE</td>
									<td class="text-gray-800"><?php echo $emp->TCLIENTE; ?></td>
								</tr>
								<tr>
		...
		<?php if ($emp->EX_EMP_IS_GROUP == 2): ?>
			<!--begin::details View-->
			<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
				<!--begin::Card header-->
				<div class="card-header pt-8">
					<div class="card-title m-0">
						<h3 class="fw-bolder m-0">Listado de empresas del grupo</h3>
					</div>
					<!--begin::Card toolbar-->
					<div class="card-toolbar">
						<!--begin::Toolbar-->
						<div class="d-flex justify-content-end" data-kt-filemanager-table-toolbar="base">
							<!--begin::Export-->
							<a href="<?php echo base_url(); ?>empresa/add_sucursal/<?php echo $id; ?>" class="btn btn-light-primary me-3">							
								<!--begin::Svg Icon | path: assets/media/icons/duotune/abstract/abs033.svg-->
								<span class="svg-icon  svg-icon-2">
									<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
					...
					<table id="kt_datatable_example_5" class="table table-striped gy-5 gs-7 border rounded table_api">
						...
						<tbody>		
							...
							foreach ($sucursales as $suc): 
								if ($suc->EX_EMP_ESTADO == 1) {$label = 'Activo'; $color = 'success';}
								elseif ($suc->EX_EMP_ESTADO == 2) {$label = 'Inactivo';$color = 'danger';}						 
								$uri = base64_encode("+_22_".$suc->PK_EX_EMPRESA."_+_ACG_Extranet_si_12_11_2019_v1_Asce_ShaoranN"); 
							?>
								<tr>
									<td><?php echo $i++;?></td>
									<td><?php echo $suc->EX_EMP_RUC; ?></td>
									<td><?php echo $suc->EX_EMP_RS; ?></td>
									<td><?php echo date('d/m/Y', strtotime($suc->EX_EMP_FEC_INICIO)); ?></td>
									<td><span class="badge <?php echo 'badge-'.$color; ?>"><?php echo $label; ?></span></td>
									<?php 
