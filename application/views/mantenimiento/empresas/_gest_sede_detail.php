				...
				<div class="card-title">
					...
					<div class="badge badge-lg badge-light-primary">
						<div class="d-flex align-items-center flex-wrap">
							...
							<!--end::Svg Icon--><?php echo $sed->EX_SEDE_NOMBRE; ?>
						</div>
					</div>
					<!--end::Folder path-->
				</div>
				...
				<table id="kt_file_manager_list" data-kt-filemanager-table="folders" class="table align-middle table-row-dashed fs-6 gy-5">
					...
					<thead>
						...
						<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
							<th class="min-w-250px">Nombre año</th>
							<th class="min-w-10px">CARPETAS</th>
							<th class="min-w-125px">ÚLTIMA MODIFICACIÓN</th>
					...
					<tbody class="fw-bold text-gray-600">
						<?php foreach ($years as $yer): 
							if ($yer->EX_ANIO_ESTADO == 1) { $label = 'Activo'; $color = 'badge-success';
								}elseif ($yer->EX_ANIO_ESTADO == 2) { $label = 'Inactivo'; $color = 'badge-danger';	
							}
							$idYear = base64_encode("+_23_".$yer->PK_EX_ANIO."_".$emp->PK_EX_EMPRESA."_".$sed->PK_SEDE_EMPRESA."_+_ACG_Extranet_si_12_11_2019_v1_Asce_ShaoranN");
							?>
							<tr>
								<!--begin::Name=-->
								<td data-order="account">
									<div class="d-flex align-items-center">
										...
										<!--end::Svg Icon-->
										<a href="<?php echo base_url(); ?>empresa/gestion_file_month/<?php echo $idYear; ?>" class="text-gray-800 text-hover-primary"><?php echo $yer->EX_ANIO_NOMBRE; ?></a>
									</div>
								</td>
								<!--end::Name=-->
								<!--begin::Size-->
								...
								<!--begin::Last modified-->
								<td>-</td>
								<td><span class="badge <?php echo $color; ?>"><?php echo $label; ?></span></td>
								<!--end::Last modified-->
								<!--begin::Actions-->
