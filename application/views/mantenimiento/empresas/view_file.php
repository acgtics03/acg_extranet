								...
								<tr>
									...
									<td data-order="authentication">
										<div class="d-flex align-items-center">
											...
											<!--end::Svg Icon-->
											<a href="#" class="text-gray-800 text-hover-primary"><?php echo $fi->EX_CARPETA_NOMBRE; ?></a>
										</div>
									</td>
									<td><?php echo '-'; ?></td>
									<td>
...
<?php 
	$this->load->view('mantenimiento/empresas/modal/maddfile');
	$this->load->view('mantenimiento/empresas/modal/meditFile');
?>
...
<script>
	function edit_file(data) {
		...
		document.getElementById("mtxtUpdIdFile").value = r[0];
		document.getElementById("mtxtUpdNomFile").value = r[2];
		document.getElementById("mtxtUpdIdMes").value = r[1];
		document.getElementById("mcboUpdFile").value = r[3];
		$('#mUpdFile').modal('show');
	}
</script>