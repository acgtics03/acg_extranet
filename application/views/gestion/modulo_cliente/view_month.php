				...
				<table id="kt_file_manager_list" data-kt-filemanager-table="folders" class="table align-middle table-row-dashed fs-6 gy-5">
					...
					<thead>
						...
						<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
							...
							<th class="min-w-100px">FECHA CREACIÓN</th>
							<th class="min-w-100px">FECHA FIN ENTREGA</th>
							...
							<tr>
								...
								<td data-order="authentication">
									<div class="d-flex align-items-center">
										...
										<!--end::Svg Icon-->
										<a href="<?php echo base_url(); ?>cliente/viewFile/<?php echo $uri; ?>" class="text-gray-800 text-hover-primary"><?php echo $me->EX_MES_NOMBRE; ?></a>
									</div>
								</td>
								<!--end::Name=-->
								<!--begin::Size-->
								<td><?php echo $me->TMES.' CARPETAS'; ?></td>
								<!--end::Size-->
								<!--begin::Last modified-->
								<td>
									<?php 
									if (!empty($me->EX_MES_FEC_REGISTRO)) {
										echo date("d/m/Y h:m:s", strtotime($me->EX_MES_FEC_REGISTRO));
									}
									?>									
								</td>
								<td class="text-danger">
									...
									$dia = sprintf("%02d",$me->dh);
									if($me->EX_CODIGO_MES == '12') {
										$mes 	= '01';
										$year 	= $me->NANIO + 1;
									}else{
										$mes = sprintf("%02d",$me->EX_CODIGO_MES + 1);
										$year = $me->NANIO;
									}
