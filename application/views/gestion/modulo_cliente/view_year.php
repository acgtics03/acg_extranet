			...
			<div class="card-header pt-8">
				...
				<div class="card-toolbar">
					...
					<div class="d-flex justify-content-end" data-kt-filemanager-table-toolbar="base">
						<!--begin::Export-->
						<button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal" data-bs-target="#maddAnio" style="display: none;">
							...
							<tr>
								...
								<td data-order="authentication">
									<div class="d-flex align-items-center">
										...
										<!--end::Svg Icon-->
										<a href="<?php echo base_url(); ?>cliente/viewMonth/<?php echo $uri; ?>" class="text-gray-800 text-hover-primary"><?php echo $yer->EX_ANIO_NOMBRE; ?></a>
									</div>
								</td>
								<!--end::Name=-->
								<!--begin::Size-->
								<td><?php echo $yer->tmes.' CARPETAS'; ?></td>
								<!--end::Size-->
								<!--begin::Last modified-->
								<td>
									<?php 
