				...
				<div class="card-header pt-8">
					...
					<div class="card-toolbar" style="display: none;">
						...
						<div class="d-flex justify-content-end" data-kt-filemanager-table-toolbar="base">
							<!--begin::Export-->
							<button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal" data-bs-target="#maddfile">
					...
					<table id="kt_file_manager_list" data-kt-filemanager-table="folders" class="table align-middle table-row-dashed fs-6 gy-5">
						...
						<thead>
							...
							<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
								...
								<th class="w-100px" style="display:none;"></th>
							</tr>
							<!--end::Table row-->
						</thead>
						<!--end::Table head-->
						...
						<tbody class="fw-bold text-gray-600">		
							<?php foreach ($files as $fi): 
								if ($fi->EX_CARPETA_ESTADO == 1) {$label = 'Activo'; $color = 'success';}
								elseif ($fi->EX_CARPETA_ESTADO == 2) {$label = 'Inactivo';$color = 'danger';}
								$uri = base64_encode("+_23_".$fi->PK_EX_CARPETA."_".$fi->FK_EX_DOC_MES."_".$fi->anio."_".$emp->PK_EX_EMPRESA."_+_ACG_Extranet_si_12_11_2019_v1_Asce_ShaoranN");
								?>
								<tr>
									<!--begin::Name=-->
									<td data-order="authentication">
										<div class="d-flex align-items-center">
											...
											<!--end::Svg Icon-->
											<a href="<?php echo base_url(); ?>cliente/viewDoc/<?php echo $uri; ?>" class="text-gray-800 text-hover-primary"><?php echo $fi->EX_CARPETA_NOMBRE; ?></a>
										</div>
									</td>
									<td><?php echo $fi->CANTARC.' Archivos'; ?></td>
									<td>
										<?php 
										if (!empty($fi->EX_CARPETA_FEC_REGISTRO)) {
											echo date("d/m/Y h:m:s", strtotime($fi->EX_CARPETA_FEC_REGISTRO));
										}
										?>									
									</td>
									<td><span class="badge <?php echo 'badge-'.$color; ?>"><?php echo $label; ?></span></td>									
									<td style="display:none;" class="text-end" data-kt-filemanager-table="action_dropdown">
											...
											<div class="ms-2">
												...
												<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-150px py-4" data-kt-menu="true">
													...
													<div class="menu-item px-3">
														<a href="#" class="menu-link px-3" onclick="edit_file(<?php echo "'".$fi->PK_EX_CARPETA.'|'.$fi->FK_EX_DOC_MES.'|'.$fi->EX_CARPETA_NOMBRE.'|'.$fi->EX_CARPETA_ESTADO."'"; ?>)">Editar</a>
													</div>
													<!--end::Menu item-->
													<!--begin::Menu item-->
													<div class="menu-item px-3">
