...
function init_settings() {
	...
	#$language = get_setting('user_1_personal_language') ? get_setting('user_2_personal_language') : get_setting("language");

	$ci->lang->load('default', 'spanish');
	$ci->lang->load('custom', 'spanish'); //load custom after loading the default. because custom will overwrite the default file.
}
